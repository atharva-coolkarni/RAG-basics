...
1. **Clone the repository**
   ```bash
   git clone https://github.com/atharva-coolkarni/RAG-basics.git
   cd RAG-basics
   ```
...
3. **Explore the notebooks**
   - Open the notebooks in the `notebook/` directory using Jupyter:
     ```bash
...
4. **Run the main script**
   ...
   python main.py
   ```
   (This may demonstrate a complete end-to-end RAG query example.)
